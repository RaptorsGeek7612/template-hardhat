...
/// @title Voting
/// @notice A whitelisted voting system driven by a fixed workflow: voter
///         registration, proposal registration, voting, then tally.
contract Voting is Ownable {
    ...
    function addProposal(string calldata _desc) external onlyVoters {
        ...
        require(keccak256(abi.encode(_desc)) != keccak256(abi.encode("")), "You can't submit an empty proposal");
